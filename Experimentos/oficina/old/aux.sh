...
../../evaluate_model.py --class1 ../../dataset/pasos_oficina_carolina_joseline_michelle/spect_sub/filtered/snr_0/carolina/test/carolina --class2 dataset/pasos_oficina_carolina_joseline_michelle/spect_sub/filtered/snr_0/joseline/test/joseline --model ../../trained_models/oficina/spect_sub/snr_0/original_snr_0 --pos_class carolina > spect_sub_snr_0.auc
