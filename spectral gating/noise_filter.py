#!/usr/bin/python3
# Source: Tim Sainburg (https://timsainburg.com/noise-reduction-python.html)
...
wav_loc = "carolina_pasos_10minutossnr_10_mix.wav"
...
def save_audios(output_path, samples, Fs, scaling=True):
    ...
    write(output_path, Fs, samples_scaled)
...
if __name__ == "__main__":
    ...
    save_audios(output_path, output, rate)
    print(output.shape)
