...
if [[ $# -eq 0 ]] ; then
	...
	mv $1/original/*pasos_10minutossnr_-10_mix_*wav $1/original/snr_-10
	mv $1/original/*pasos_10minutossnr_-5_mix_*wav $1/original/snr_-5
	mv $1/original/*pasos_10minutossnr_0_mix_*wav $1/original/snr_0
	mv $1/original/*pasos_10minutossnr_5_mix_*wav $1/original/snr_5
	mv $1/original/*pasos_10minutossnr_10_mix_*wav $1/original/snr_10

	mv $1/filtered/*pasos_10minutossnr_-10*wav $1/filtered/snr_-10
	mv $1/filtered/*pasos_10minutossnr_-5*wav $1/filtered/snr_-5
	mv $1/filtered/*pasos_10minutossnr_0_mix_*wav $1/filtered/snr_0
	mv $1/filtered/*pasos_10minutossnr_5_mix_*wav $1/filtered/snr_5
	mv $1/filtered/*pasos_10minutossnr_10_mix_*wav $1/filtered/snr_10
